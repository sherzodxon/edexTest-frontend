        ...
        <div className="space-y-4 text-white">
            <div className="flex justify-between items-center mb-4">
                <h1 className="text-lg sm:text-2xl font-bold flex items-center gap-2">
                    <FileText className="text-[#DA70D6] w-5 h-5 sm:w-8 sm:h-8"/>
                    <span className="hidden sm:inline">Testlar boshqaruvi</span>
                    ...
                    <div className="space-y-3">
                        {filtered.map((test) => (
                            <div
                                ...
                                <div>
                                    <h2 className="font-semibold text-sm sm:text-lg">{test.title}</h2>
                                ...
                                <button onClick={() => handleDelete(test.id)} className="p-1">
